...
CPPSOURCES = src/check/BackwardChecker.cpp src/model/AigerModel.cpp src/model/CarSolver.cpp src/model/MainSolver.cpp src/model/InvSolver.cpp src/model/State.cpp src/main.cpp\
