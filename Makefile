...
CPPSOURCES = src/check/BackwardChecker.cpp src/model/AigerModel.cpp src/model/CarSolver.cpp src/model/MainSolver.cpp src/model/InvSolver.cpp src/model/State.cpp src/main.cpp src/model/OverSequence.cpp src/model/Log.cpp src/model/OverSequenceForProp.cpp\
...
OBJS = BackwardChecker.o AigerModel.o CarSolver.o State.o main.o aiger.o MainSolver.o InvSolver.o OverSequence.o Log.o OverSequenceForProp.o\
