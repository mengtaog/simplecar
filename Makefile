...
CPPSOURCES = checker.cpp carsolver.cpp mainsolver.cpp model.cpp utility.cpp data_structure.cpp main.cpp util.cpp\
...
OBJS = checker.o carsolver.o mainsolver.o model.o main.o utility.o data_structure.o aiger.o util.o\
