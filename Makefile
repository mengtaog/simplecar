...
CPPSOURCES = src/check/BackwardChecker.cpp src/model/AigerModel.cpp src/model/CarSolver.cpp src/model/State.cpp src/main.cpp\
...
OBJS = BackwardChecker.o AigerModel.o CarSolver.o State.o main.o aiger.o\
